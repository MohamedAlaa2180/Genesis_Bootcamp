...
public class PLayerIdelState : PlayerState {
    public PLayerIdelState(PlayerMovementStateMachine playerMovingStateMachine) : base(playerMovingStateMachine) {
    }
    ...
    public override void Update() {
        ...
        if (_playerMovingStateMachine.PlayerMovement.MovementVector.magnitude > 0.1f) {
            _playerMovingStateMachine.ChangeState(_playerMovingStateMachine.MovingState);
        }
